...
namespace Cooperchip.ITDeveloper.Domain.Entities
{
    public class Produto
    {
        ...
        [Required(ErrorMessage = "O campo {0} é obrigatório")]
        [Range(0, 4000, ErrorMessage = "O campo {0} deve estar entre {0} e {2} reais")]
        ...
        [DataType(DataType.Date, ErrorMessage = "Data Invalida"), DisplayFormat(DataFormatString ="{0:dd/MM/yyyy HH:mm}")]
